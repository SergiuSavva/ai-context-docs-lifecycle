...
| File | Purpose |
|------|---------|
| `content/modules/01-quick-start/templates/AGENTS-single-app.md` | Single app template |
| `content/modules/01-quick-start/templates/AGENTS-monorepo-root.md` | Monorepo root template |
| `content/modules/01-quick-start/templates/AGENTS-monorepo-subproject.md` | Subproject template |
...
| File | Change |
|------|--------|
| `content/modules/01-quick-start/README.md` | Template selection guide |
