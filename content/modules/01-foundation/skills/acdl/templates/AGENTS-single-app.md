...
<!-- If skills are set up in .agents/skills/, add routing rows like:
     | Writing specs / task breakdowns | load skill `feature` |
     | Writing docs / ADRs | load skill `docs` |
     | Feature workflow | load skill `feature` |
     | What should I do next? / Resume work | load skill `feature` |
