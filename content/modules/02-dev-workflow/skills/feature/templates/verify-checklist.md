...
If the user reports problems during review, infer severity — don't ask "how severe?"
...
4. When the user reports an issue, infer severity from their words (see Issue Triage) — never ask for severity
5. This checklist is the Definition of Done — do not proceed to closeout until all checks pass and the user approves
