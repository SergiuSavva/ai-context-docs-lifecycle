...
> **Scope**: BACKLOG.md owns **what to build and priority**. For progress tracking across features, see `TASKS.md`. For phase/release grouping, see `ROADMAP.md`.
...
| Feature | State | Spec | Notes |
|---------|-------|------|-------|
| {{Feature Name}} | Idea | - | Future consideration |
| {{Feature Name}} | Idea | - | |
...
|---------|-----------|------------|
| {{Feature Name}} | {{Date}} | {{Link to docs or ADR if applicable}} |
| {{Feature Name}} | {{Date}} | - |
...
3. Link to relevant docs (ADR if a significant decision was made)
